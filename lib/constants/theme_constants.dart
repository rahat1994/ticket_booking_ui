...
final lightTheme = ThemeData(
	...
	textTheme: TextTheme(
		...
		body1: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w500, color: config.Colors().secondColor(1)),
		body2: TextStyle(fontSize: 14.0, color: config.Colors().secondColor(1)),
		caption: TextStyle(fontSize: 17.0,fontWeight: FontWeight.w400, color: config.Colors().hintColor(0.8)),
